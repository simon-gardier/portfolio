  ...
  shortcuts: [
    {
      ...
      "nav-item": "underline-offset-4 text-fg-light hover:text-fg-dark transition-colors duration-200",
      "nav-active": "underline decoration-wavy text-fg-dark font-semibold",
